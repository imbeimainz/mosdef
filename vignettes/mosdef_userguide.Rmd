...
Instead of differentially expressed genes, in the volcanoPlot you can also highlight genes associated with a certain GOterm of interest.
...
# For further parameters please check the function documentation # TODO can we say that here? Or would an example including all parameters be better?
maplot
```
