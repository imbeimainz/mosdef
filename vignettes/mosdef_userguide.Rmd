...
RMDs are a great way of handing over reports to colaborators. These functions are supposed to improve report quality by upgrading the report turning normal tables into interactive tables linking to further websites.
