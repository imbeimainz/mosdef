...
#'
#' @return An invisible `NULL` after performing the checks on the `DESeqResult` object; 
#' if not all conditions are satisfied, this function returns messages stating which columns
#' are missing
#'
#' @export
#'
...
#' @param verbose  Logical, whether to add messages telling the user which steps were taken
#'
#' @return @return An invisible `NULL` after performing the checks on the `DESeqDataset` object; 
#' if not all conditions are satisfied, this function returns messages stating which elements
#' are missing
#'
#' @export
#'
