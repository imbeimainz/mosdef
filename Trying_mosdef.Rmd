...
```{r runfullde, cache=TRUE, message =FALSE}
...
```{r}
myresuSet_lisamarie[[1]][["etbl_res_DE_test"]] <- buttonifier(myresuSet_lisamarie[[1]][["etbl_res_DE"]], output_format = "DF")

myresuSet_lisamarie[[2]][["etbl_res_DE_test"]] <- buttonifier(myresuSet_lisamarie[[1]][["etbl_res_DE"]], new_cols =c("NCBI", "HPA"), output_format = "DF")


#showing all the buttons in one
myresuSet_lisamarie[[3]][["etbl_res_DE_test"]] <- buttonifier(myresuSet_lisamarie[[1]][["etbl_res_DE"]], new_cols =c("GC", "NCBI", "GTEX", "UNIPROT", "dbPTM", "HPA"), output_format = "DF")
```
Now for the display:

```{r}
DT::datatable(myresuSet_lisamarie[[1]][["etbl_res_DE_test"]],escape=FALSE, rownames=FALSE )
DT::datatable(myresuSet_lisamarie[[2]][["etbl_res_DE_test"]] ,escape=FALSE, rownames=FALSE)
DT::datatable(myresuSet_lisamarie[[3]][["etbl_res_DE_test"]] ,escape=FALSE, rownames=FALSE)
```
...
```{r topgorun-upreg, results="hide", cache=TRUE, message = FALSE}
#for fun look at upreg only

  
  myresuSet_lisamarie[[1]][["topGO_tbl_upreg"]] <- 
    topGOtable(res_de = myresuSet_lisamarie[[1]][["res_DESeq"]], 
               dds = dds_NK, 
               ontology = "BP",
               geneID = "symbol",
               add_gene_to_terms = TRUE,
  ...
  myresuSet_lisamarie[[2]][["topGO_tbl_upreg"]] <- 
    topGOtable(res_de = myresuSet_lisamarie[[1]][["res_DESeq"]], 
               dds = dds_NKRH30, 
               ontology = "BP",
               geneID = "symbol",
    ...
    myresuSet_lisamarie[[3]][["topGO_tbl_upreg"]] <- 
    topGOtable(res_de = myresuSet_lisamarie[[1]][["res_DESeq"]], 
               dds = dds_RH30, 
               ontology = "BP",
               geneID = "symbol",
...
DT::datatable(myresuSet_lisamarie$NK_BV6_vs_untrt$topGO_tbl,escape=FALSE, rownames=FALSE)
DT::datatable(myresuSet_lisamarie$RH30_BV6_vs_untrt$topGO_tbl,escape=FALSE, rownames=FALSE)
